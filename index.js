...
const unfundedGamesMessage = unfundedGamesCount > 0 
    ? `We have raised $${totalRaised.toLocaleString()} for ${GAMES_JSON.length} games! Currently, there are ${unfundedGamesCount} unfunded game${unfundedGamesCount > 1 ? 's' : ''}. Consider supporting these games!`
    : `We have raised $${totalRaised.toLocaleString()}! All ${GAMES_JSON.length} games have been funded! Thank you for supporting all our games!`;
